...
1. **Discover Available Skills**:
   ...
   - For maximum compatibility, check project/workspace skill directories in `.codex/skills/**/prompts:skill.md`, `.codex/skills/**/prompts:skill.md`, and `.agents/skills/**/prompts:skill.md`
   - Also check user/home skill directories in `~/.codex/skills/**/prompts:skill.md`, `~/.codex/skills/**/prompts:skill.md`, and `~/.agents/skills/**/prompts:skill.md`
